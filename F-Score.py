...
if(ROA>=0):
    print("POINT 1: For positive ROA")
else:
    print("POINT 0: For negative ROA")

if(CFO>=0):
    print("POINT 1: For positive CFO")
else:
    print("POINT 0: For negative CFO")

if(CFO>ROA):
    print("POINT 1: For CFO>ROA")
else:
    print("POINT 0: For CFO<ROA")

if (Dfina>=0):
        print("POINT 1: For ROA of current year> ROA of previous year")
else:
        print("POINT 0: For ROA of current year< ROA of previous year")
if (DLEV11>=0):
        print("POINT 1: For the positice changes of leverage")
else:
        print("POINT 0: For the negative changes of leverage")

if (p==int):
        print("POINT 0: If common equity increases compared to prior year")
else:
        print("POINT 1: For no equity changes")
if (DLC0>=0):
        print("POINT 1: If the current ratio increases from the prior year")
else:
        print("POINT 0: If the current ratio decreases from the prior year")

if (DG0>=0):
        print("POINT 1: Positive changes of gross margin ratio")
else:
        print("POINT 0: Negative cganges of gross margin ratio")

if (DTUE1>=0):
        print("POINT 1: For the enhanchment of asset turnover")
else:
        print("POINT 0: Low asset turnover compared with previous year")
